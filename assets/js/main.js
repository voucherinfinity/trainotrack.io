...
$('#ship-box').on('click', function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
	 ...
	 fetch('/it-fourm.html') // Fetching the page from the root folder
	   .then(response => response.text())
	   .then(data => document.getElementById('forum-content').innerHTML = data)
	   .catch(error => console.error('Error fetching the forum:', error));
